...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.t = 0
        self.state_def = [
            ['turn_left', 'turn_right', 'forward'], #waypoint
            ['red', 'green'],                                             #light
            ['turn_left', 'turn_right', 'forward', None],            #Input left
            ['turn_left', 'turn_right', 'forward', None]            #Input right
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = math.exp(-self.alpha * self.t) # self.epsilon - 0.05
            self.t += 1
        return None
    ...
    def get_maxQ(self, state):
        ...
        maximum_Q = max(actions.items(), key=lambda x: x[1])[1]
